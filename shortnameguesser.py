...
def predict_long_names(shortname: str):
    ...
    completions = ai.ChatCompletion.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": f"Make a list of guesses, separated by newlines, for what the rest of the word could be from this snippet. Ensure that the snippet is a substring of your guess. Make as many guesses as you can. Snippet: {shortname}"
            },
        ],
    )
